...
app.get("/scrape", function(req, res) {
    ...
    axios.get("http://www.nhl.com/stars/").then(function(response) {
        ...
        $("ul.mixed-feed__list").find("li").each(function(i, e) {
            var summary = $(e).find("div.mixed-feed__item-header-text").find("h5").text()
                // console.log(summary);
            var headline = $(e).find("div.mixed-feed__item-header-text").find("h4").text()
                // console.log(headline);
            var link = "https://www.nhl.com" + $(e).find("div.mixed-feed__item-header-text").find("a").attr("href")
                // console.log(link);
